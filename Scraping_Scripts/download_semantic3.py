...
queries = [
    'business intelligence maturity model university',
    'educational data mining business intelligence roadmap',
    'tableau business intelligence dashboard higher education student retention'
]
