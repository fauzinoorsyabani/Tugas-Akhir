...
queries = [
    'business intelligence roadmap pendidikan',
    'business intelligence roadmap universitas',
    'business intelligence roadmap perguruan tinggi',
    'business intelligence roadmap Moss',
    'business intelligence tableau pendidikan'
]
            ...
            for item in data:
                ...
                if pdf_info and pdf_info.get('url'):
                    ...
                    if not pdf_url.lower().endswith('.pdf'):
                        # some might not be direct links, we'll try anyway
                        pass
